<template>
    <!-- =============== POPUP ADD MOVIE =============== -->
    <div v-if="popup.showPopup" class="popup-backdrop">
      <div class="popup-container">

        <div class="popup-header">
          <span class="popup-label-text">Add movie:</span>
          <span class="movie-title">{{ popup.selectedMovie?.title }} ({{ popup.selectedMovie?.year }})</span>
    ...
    <!-- =============== POPUP CREATE LIST =============== -->
    <div v-if="popup.showCreatePopup" class="popup-backdrop">
...
watch(
  () => popup.selectedMovie,
  (val) => {
    console.log('popup sees selectedMovie:', val)
  },
  { immediate: true }
)

const addMovieToList = (listId) => {
  auth.addMovieToWatchlist(listId, popup.selectedMovie)
  popup.closeAll()
}

const openCreatePopup = () => {
  popup.openCreatePopup()
}

const goBackPopup = () => {
  popup.closeCreatePopup()
}
